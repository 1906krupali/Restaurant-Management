		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap" style="margin-top:-15%;" >
					...
					<div class="fh5co-item animate-box">
						<img src="images/orange.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Orange Juice</h3>
						<span class="fh5co-price">&#8377;  50<sup>.50</sup></span>
						<p>Orange juice is a refreshing beverage made from freshly squeezed oranges, offering a vibrant, tangy flavor and a burst of vitamin C. Perfect for a healthy start to your day or as a revitalizing drink any time.</p>
					</div>
					<div class="fh5co-item animate-box">
						<img src="images/watermelon.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Watermelon juice</h3>
						<span class="fh5co-price">&#8377;  30<sup>.50</sup></span>
						<p>Watermelon juice is a refreshing and hydrating beverage made from the sweet, juicy flesh of ripe watermelons. Its natural sweetness and vibrant color make it a perfect thirst-quencher on a hot day.</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap"style="margin-top:-20%;">
					...
					<div class="fh5co-item animate-box">
						<img src="images/Cocktails.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Cocktail</h3>
						<span class="fh5co-price">&#8377;  80<sup>.50</sup></span>
						<p>A cocktail is a mixed drink typically made with a combination of spirits, liqueurs, fresh juices, and various flavorings.</p>
					</div>
					<div class="fh5co-item animate-box">
						<img src="images/Blueberry-Maple.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;" >
						<h3>BlueBerry Mapel </h3>
						<span class="fh5co-price">&#8377;  45<sup>.50</sup></span>
						<p>Blueberry Maple is a delectable combination of fresh blueberries and sweet maple syrup. This pairing is often used in pancakes, waffles, or desserts, offering a delightful blend of fruity and rich, syrupy flavo&#8377;  </p>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap"style="margin-top:-15%;">
					...
					<div class="fh5co-item animate-box">
						<img src="images/IcedCoffee.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Cold Coffee</h3>
						<span class="fh5co-price">&#8377;  100<sup>.50</sup></span>
						<p>Cold coffee is a refreshing beverage made from brewed coffee that's chilled and often blended with ice, milk, and sweetene&#8377;   Its smooth, invigorating flavor makes it a perfect pick-me-up on warm days.</p>
					</div>
					<div class="fh5co-item animate-box">
						<img src="images/pineapple.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Pineapple Juice</h3>
						<span class="fh5co-price">&#8377;  40<sup>.50</sup></span>
						<p>Pineapple juice is a tropical beverage made from the sweet, tangy flesh of ripe pineapples. Packed with vitamin C and refreshing in taste, it’s perfect for a revitalizing drink or as a mixer in cocktails.</p>
					</div>
					<div class="fh5co-item animate-box">
						<img src="images/lemon_1.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Lemon juice</h3>
						<span class="fh5co-price">&#8377;  20<sup>.50</sup></span>
						<p>Lemon juice is a zesty and tangy beverage made from freshly squeezed lemons, offering a refreshing burst of citrus flavor. It's a versatile ingredient, perfect for adding a tart touch to drinks, marinades, and dressings.</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap"style="margin-top:-20%;">
					<div class="fh5co-item margin_top animate-box">
					...
					<div class="fh5co-item animate-box">
						<img src="images/cofee.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Hot Coffee</h3>
						<span class="fh5co-price">&#8377;  150<sup>.50</sup></span>
						<p>Hot coffee is a comforting beverage brewed from roasted coffee beans, offering a rich, aromatic flavor and a stimulating dose of caffeine. Perfect for a morning boost or a cozy moment, it's enjoyed black or with milk and sweetene&#8377;  </p>
					</div>
					<div class="fh5co-item animate-box">
						<img src="images/mango.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Mango juice</h3>
						<span class="fh5co-price">&#8377;  60<sup>.50</sup></span>
						<p>Mango juice is a luscious, tropical beverage made from the sweet and succulent pulp of ripe mangoes. Bursting with vibrant flavor and rich in vitamins, it’s a refreshing drink perfect for any time of day.</p>
					</div>
					<div class="fh5co-item animate-box">
						<img src="images/lychee-1.jpg" class="img-responsive" alt="Free"style="height:200px; width:300px;">
						<h3>Lychee juice</h3>
						<span class="fh5co-price">&#8377;  40<sup>.50</sup></span>
						<p>Lychee juice is a delicate and refreshing beverage made from the sweet, fragrant flesh of ripe lychees. </p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 fh5co-heading animate-box"style="margin-top:-20%;">
					...
					<div class="row">
						<div class="col-md-6">
							<p>A testimony is a formal statement or declaration given as evidence in a legal proceeding or public forum. It often involves a witness sharing their firsthand account of events, experiences, or expertise to support or refute a claim.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-7 animate-box"style="margin-top:-10%;">
					<blockquote>
