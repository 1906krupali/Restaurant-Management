		...
		<div class="row">
			...
			<div class="col-xs-12 text-center menu-1 menu-wrap">
				<ul>
					...
					<li class="active"><a href="order_online1.php">Order Online</a></li>
					<li>
                        <a href="cart.php">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap" style="margin-top:-10%; align-items:center;">
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%;height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Bake%20Potato%20Pizza', 95.50, 'images/bake patato.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Veg%20Manchurian', 150.50, 'images/veg-manchurain.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
            <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('Mango%20Juice', 60.50, 'images/mango.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
            <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('Orange%20Juice', 50.50, 'images/orange.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
            <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('Cappuccino', 120.50, 'images/cappuccino-1.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap" style="margin-top:-15%;">
                <div class="fh5co-item margin_top animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Burger%20&%20French%20Fries', 120.00, 'images/gallery_3.jpeg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Hakka%20Noodles', 80.50, 'images/hakka-noodles.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('WaterMelon%20Juice', 30.50, 'images/watermelon.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
            <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('Blueberry%20Maple', 45.50, 'images/Blueberry-Maple.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
            <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('Latte%20Art', 140.50, 'images/latte-art.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap" style="margin-top:-10%;">
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Italian%20Sauce%20Mushroom', 90.99, 'images/italian-mushroom.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Garlic%20Pizza', 120.50, 'images/garlic-pizza.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                ...
                <button class="btn btn-primary" onclick="addToCart('Pineapple%20Juice', 40.50, 'images/pineapple.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
            </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Lemon%20Juice', 20.50, 'images/lemon.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Hot%20Coffee', 50.50, 'images/hot-coffee.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap" style="margin-top:-15%;">
                ...
                <div class="fh5co-item margin_top animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Chees%20Pizza', 120.50, 'images/chees-pizza.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('White%20Pizza', 100.50, 'images/white_pizza.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Lychee%20Juice', 40.50, 'images/lychee-1.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Cocktails', 80.50, 'images/Cocktails.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
                <div class="fh5co-item animate-box" style="border: 2px solid #ccc; padding: 10px; margin-bottom:5%; height:380px;">
                    ...
                    <button class="btn btn-primary" onclick="addToCart('Cold%20Coffee', 100.50, 'images/IcedCoffee.jpg')"><a href="order_online1.php" style="color:white">Add To Cart</a></button>
                </div>
             </div>
        </div>
    </div>
