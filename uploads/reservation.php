...
<html>
	...
	<div id="fh5co-reservation-form" class="fh5co-section">
		<div class="container">
			<div class="row">
				<div class="col-md-12 fh5co-heading animate-box" style="margin-top:-8%;">
					<h2>Reservation</h2>
					<div class="row">
						<div class="col-md-6">
				...
				<div class="col-md-6 col-md-push-6 col-sm-6 col-sm-push-6" style="margin-top:-8%;">
					<form action="#" id="form-wrap">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<select name="many" id="many" class="form-control custom_select" style="background-color:black;">
	...
	<div id="fh5co-featured-testimony" class="fh5co-section">
		<div class="container">
			<div class="row">
				<div class="col-md-12 fh5co-heading animate-box" style="margin-top: -15%;">
					<h2>Testimony</h2>
					<div class="row">
						<div class="col-md-6">
				...
				<div class="col-md-5 animate-box img-to-responsive animate-box" data-animate-effect="fadeInLeft" style="margin-top:-8%;">
